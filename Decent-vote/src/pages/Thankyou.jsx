...
const ThankYou = () => {
  // Get the state passed from the VotingForm component (i.e., voteId)
  const location = useLocation();
  const { voteId } = location.state || {}; // Default to empty if no state passed
