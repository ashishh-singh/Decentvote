...
export default function NavbarIcons() {
  ...
  return (
    <>
      ...
      <header className=" fixed z-20 w-full border-b border-white  bg-white shadow-lg shadow-slate-700/5 after:absolute after:left-0 after:top-full after:z-10 after:block after:h-px after:w-full after:bg-white lg:border-slate-200 lg:backdrop-blur-sm lg:after:hidden">
